...
| Phase 4 synthetic Chat full gate | `powershell -NoProfile -ExecutionPolicy Bypass -File tools/reengineering/run-phase4-verification.ps1` | controller persistence/terminal/cancel/hydration-order invariants, exact-loopback fixture lifecycle, packet controls, mock-local/cloud UI, streamed-delta visibility, reload, lossless snapshot merge, diagnostics, mobile/a11y media, unchanged `/`, deterministic build, audit/SBOM/supply chain, clean reproduction | Windows 10; Node 24.13.0; TypeScript 6.0.3; Playwright 1.62.0; installed Chrome channel | 63 unit/control assertions; 187 repository controls; 8 browser cases | canonical and detached-worktree GREEN; 63/63 assertions; 187/187 controls; 7 browser pass and 1 explicit offline-contract skip | [canonical summary](../reengineering/evidence/phase-4/LW-P4-001/summary.json); [independent review](../reengineering/evidence/phase-4/LW-P4-001/independent-review/REVIEW.md) |
