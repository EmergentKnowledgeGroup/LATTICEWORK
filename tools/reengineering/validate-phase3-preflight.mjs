...
const ALLOWED_PREFLIGHT_SCOPE = new Set([
  ...
  "reengineering/evidence/phase-3/LW-P3-PREFLIGHT-001/commands/controls/manifest.json",
  "reengineering/evidence/phase-3/LW-P3-PREFLIGHT-001/commands/controls/stderr.log",
  "reengineering/evidence/phase-3/LW-P3-PREFLIGHT-001/commands/controls/stdout.log",
  "reengineering/evidence/phase-3/LW-P3-PREFLIGHT-001/commands/focused/manifest.json",
  "reengineering/evidence/phase-3/LW-P3-PREFLIGHT-001/commands/focused/stderr.log",
  "reengineering/evidence/phase-3/LW-P3-PREFLIGHT-001/commands/focused/stdout.log",
  "reengineering/evidence/phase-3/LW-P3-PREFLIGHT-001/commands/hygiene/manifest.json",
  "reengineering/evidence/phase-3/LW-P3-PREFLIGHT-001/commands/hygiene/stderr.log",
  "reengineering/evidence/phase-3/LW-P3-PREFLIGHT-001/commands/hygiene/stdout.log",
  "reengineering/evidence/phase-3/LW-P3-PREFLIGHT-001/commands/validator/manifest.json",
  "reengineering/evidence/phase-3/LW-P3-PREFLIGHT-001/commands/validator/stderr.log",
...
function validateGitScope(root, baseSha, terminalSha, failures) {
  ...
  if (phaseAncestry.status !== 0) {
    failures.push(
      `implementation base commit ${baseSha} is not an ancestor of Phase 3 terminal commit ${terminalSha}`,
    );
    return;
  }
  ...
  let changed = [];
  try {
    changed = collectClosedRangePaths(root, baseSha, terminalSha);
  } catch (error) {
...
export function validatePhase3Preflight({
  ...
  checkGitScope = true,
  gitScopeBase = EXPECTED_IMPLEMENTATION_BASE_COMMIT,
  gitScopeTerminal = EXPECTED_PHASE3_TERMINAL_COMMIT,
}) {
  ...
  return {
    ...
    gitScopeBase: checkGitScope ? gitScopeBase : null,
    gitScopeTerminal: checkGitScope ? gitScopeTerminal : null,
    checks: {
...
if (isMain()) {
  try {
    ...
    if (
      ...
      throw new Error(
        "canonical CLI validation always checks Git scope from the pinned preflight base and terminal commits",
      );
    }
