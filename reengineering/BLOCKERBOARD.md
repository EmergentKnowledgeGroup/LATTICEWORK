...
| `LW-BLK-005` | P1 | P3-P10 | ADR-004 is accepted; data owners, schemas, retention, expanded descriptor coverage, and final independent migration evidence remain incomplete | Bounded synthetic conversation migration/rollback/round-trip implementation is locally green; no real data | Maintainer/data lead | Expanded inventory and independently verified synthetic migration/rollback/round-trip fixtures | OPEN |
