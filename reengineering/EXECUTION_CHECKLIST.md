...
| `LW-P3-DEC-001` | 3 | `IN_PROGRESS` | ADR-004..006, decision packet, controls, living docs | P2-001 | 5 | Proposal is internally consistent, scope-safe, reviewable, and grants no runtime authority | packet validator; negative fixtures; full repository controls; independent source review | `PHASE3_DECISION_PACKET.*`, handoff pending | Revert proposal-only files; Phase 2 foundation unchanged |
