...
| `LW-P2-001` | 2 | `DONE` | workspace, kernel, contracts, empty shell | Accepted ADR-001..003, P1-001 | 8 | Strict typed shell builds/boots; legacy remains runnable; generated output reproducible | 3-workspace typecheck; 5/5 unit; 37/37 controls; two byte-identical builds; 6/6 browser; audit/SBOM/boundary/validator; separate-port independent reproduction | `evidence/phase-2/LW-P2-001/` | Delete candidate shell commit; baseline unchanged |
