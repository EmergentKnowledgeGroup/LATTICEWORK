...
| Local model connection | pending | none | C0 | none | Phase 3 provider-contract decision |
| Cloud provider connection | pending | none | C0 | none | Phase 3 provider/security decision |
| Chat shell | `evidence/phase-1/LW-P1-001/` | none | C2 | none | Phase 4 feature migration |
| Chat send/stream/cancel/retry and persistence | pending | none | C0 | none | Phase 3/4 data-provider gates |
...
| Accessibility | forced-colors/reduced-motion screenshot only | none | C0 | none | feature-equivalent accessibility gate |
